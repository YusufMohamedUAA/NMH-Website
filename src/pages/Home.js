...
const Home = () => {
  ...
  border="2px"
>
  {/* Container for moving content */}
  <Box mt="100px" flex="1"> {/* Adjust mt to move content down */}
    <Box position="absolute" top="40px" left="50%" transform="translateX(-50%)" zIndex="1">
  ...
  <Box as="footer" textAlign="center" py={0} bg="nmh.primary" color="nmh.secondary" mt="auto">
